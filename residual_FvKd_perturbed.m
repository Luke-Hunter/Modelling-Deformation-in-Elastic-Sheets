...
function [R,J,sigma,d_sigma_dr]=residual_FvKd_perturbed(guess,F,nlc,mu,nu,pc)
#
...
# extra terms including pc are the extra terms from the modified strain tensor (pc = h^2/R^2)
epsilon_fct = {...
  @(n,fd_fct)(fd_fct(1)(U,n,h)+nlc*0.5*fd_fct(1)(W,n,h).^2+pc*0.5*fd_fct(1)(W,n,h).^2),...
  @(n,fd_fct) 0.0,...
  @(n,fd_fct) (U(n)./r(n)+pc*0.5*(U(n)./r(n)).^2)...
 };

d_epsilon_fct_dr = {...
  @(n,fd_fct)(fd_fct(2)(U,n,h)+nlc*fd_fct(1)(W,n,h).*fd_fct(2)(W,n,h)+pc*fd_fct(2)(U,n,h).*fd_fct(1)(U,n,h)),...
  @(n,fd_fct) 0.0,...
  @(n,fd_fct) (r(n).*fd_fct(1)(U,n,h)-U(n))./(r(n).^2+pc*(r(n).*fd_fct(1)(U,n,h)-U(n))./(r(n).^2).*(U(n)./r(n)))...
  };
...
%  sigma_ij,j = 0
R2(n)= d_sigma_dr{1}(n) + (sigma{1}(n)-sigma{3}(n))./r(n);
...
if(nargout>1)
 ...
 d_epsilon_du_fct = {...
  @(n,m,fd_fct,dfd_fct) dfd_fct(1)(n,m,h)+pc*nlc*dfd_fct(1)(n,m,h).*fd_fct(1)(U,n,h),...
  @(n,m,fd_fct,dfd_fct) 0.0, ...
  @(n,m,fd_fct,dfd_fct) (delta(n,m)./r(n)).*(1+pc*(U(n)./r(n)))};
 ...
 d2_epsilon_dr_du_fct ={...
  @(n,m,fd_fct,dfd_fct) dfd_fct(2)(n,m,h)+pc*nlc*dfd_fct(2)(n,m,h).*fd_fct(1)(U,n,h)+pc*nlc*dfd_fct(1)(n,m,h).*fd_fct(2)(U,n,h),...
  @(n,m,fd_fct,dfd_fct) 0.0,... 
  @(n,m,fd_fct,dfd_fct)-delta(n,m)./(r(n).^2)+dfd_fct(1)(n,m,h)./r(n)+pc*((dfd_fct(1)(n,m,h).*U(n))./(r(n).^2))+pc*((delta(n,m).*fd_fct(1)(U,n,h))./(r(n).^2))-2*pc*((U(n).*delta(n,m))./(r(n).^3))};
